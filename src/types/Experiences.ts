export const experiences = [
  ...
  },
  {
    ...
    date: "2022 - 2024",
    contents: [
      "• Monitoring and preparing analytical reports on the observation of foreign aircraft traffic in Indonesian airspace based on several parameters form closed sources.",
      "• Monitoring and preparing analytical reports on the observation of Indonesian maritime areas, focusing on vessels suspected of engaging activities based on alarm parameters form closed sources.",
      "• Creating maps and analytical reports of land areas affected by natural disasters and illegal mining using ArcGIS Map software. ",
    ],
  },
];
